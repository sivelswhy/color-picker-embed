...
function copy() {
    ...
    console.log('test')
    navigator.clipboard.writeText(`${window.location}?color=${color}`).then(function() {
        iziToast.show({
...
colorInput.addEventListener("change", (event) => {
  ...
  copylink.innerHTML = `Here's the link that let's you transfer this color :<br><br> <a onclick="copy()">${window.location}</a>`
